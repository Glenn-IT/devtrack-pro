...
const Sidebar = ({ open, onClose }) => (
  <>
    ...
    <aside
      ...
      style={{
        background: "linear-gradient(180deg, #041421 0%, #042630 100%)",
      }}
    >
      {/* Logo */}
      <div className="flex items-center justify-between px-6 py-5 border-b border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-xs" style={{ color: "#86b9b0" }}>
              Neko-Sysdev
            </span>
          </div>
        </div>
      ...
      <div className="px-4 pb-6">
        <div
          ...
          style={{ background: "rgba(76,114,115,0.25)" }}
        >
          <p className="font-semibold text-white text-xs">Neko-Sysdev</p>
          <p className="text-xs mt-0.5" style={{ color: "#86b9b0" }}>
            Project Manager by Glenard Pagurayan
          </p>
          <p className="text-xs mt-2" style={{ color: "#4c7273" }}>
            © 2026 DevTrack Pro. All rights reserved.
          </p>
        </div>
      </div>
    </aside>
